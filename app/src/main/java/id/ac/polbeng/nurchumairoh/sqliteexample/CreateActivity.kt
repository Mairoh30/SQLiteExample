...
import id.ac.polbeng.nurchumairoh.sqliteexample.databinding.ActivityCreateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSimpan.setOnClickListener {
            ...
            if(nim.isEmpty() || name.isEmpty() || age.isEmpty()){
                Toast.makeText(this, "Sila masukan data nim, nama, dan umur!", Toast.LENGTH_SHORT).show()
