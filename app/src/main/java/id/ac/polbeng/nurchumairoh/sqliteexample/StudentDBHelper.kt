package id.ac.polbeng.nurchumairoh.sqliteexample
...
class StudentDBHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBContract.UserEntry.TABLE_NAME + " (" + DBContract.UserEntry.COLUMN_NIM + " TEXT PRIMARY KEY," + DBContract.UserEntry.COLUMN_NAME + " TEXT," + DBContract.UserEntry.COLUMN_AGE + " TEXT)"
